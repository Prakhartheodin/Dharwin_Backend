...
const userSchema = mongoose.Schema(
  {
    ...
    notificationPreferences: {
      ...
      taskAssignmentsInApp: { type: Boolean, default: true },
      applicationUpdates: { type: Boolean, default: true },
      applicationUpdatesInApp: { type: Boolean, default: true },
      offerUpdates: { type: Boolean, default: true },
      offerUpdatesInApp: { type: Boolean, default: true },
      meetingInvitations: { type: Boolean, default: true },
      meetingInvitationsInApp: { type: Boolean, default: true },
      meetingReminders: { type: Boolean, default: true },
      meetingRemindersInApp: { type: Boolean, default: true },
      certificates: { type: Boolean, default: true },
      certificatesInApp: { type: Boolean, default: true },
      courseUpdates: { type: Boolean, default: true },
      courseUpdatesInApp: { type: Boolean, default: true },
